			...
			<form name="frm" action="memoEdit" method="post">
				<table class="table mt-3">
					...
					<tr>
						...
						<td width="80%"><input type="text" name="idx" value="${memo.idx }"
							class="form-control" placeholder="Idx" readonly></td>
					</tr>
					<tr>
						<td width="20%"><b>작성자</b></td>
						<td width="80%"><input type="text" name="name" value="${memo.name }"
							class="form-control" placeholder="Name" style=""></td>
					</tr>
					<tr>
						<td width="20%"><b>메모 내용</b></td>
						<td width="80%"><input type="text" name="msg" value="${memo.msg }"
							class="form-control" placeholder="Message" style=""></td>
					</tr>
					<tr>
						<td colspan="2" class="text-center">
							<!-- button에 type을 기술하지 않으면 기본이 submit버튼 -->
							<button type="button" class="btn btn-primary" onclick="check()" >글 수정하기</button> 
